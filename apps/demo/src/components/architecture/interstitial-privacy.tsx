...
/* Between PrivacyTable and TransactionFlow */
export function InterstitialPrivacy() {
  return (
    <section
      ...
      <div className="flex flex-col lg:flex-row" style={{ minHeight: "320px" }}>
        ...
        >
          ...
          <div className="mt-1" style={{
            ...
            Side, price, amount stay inside the TEE.
          </div>
        </div>
        ...
        <div className="relative flex-1 overflow-hidden" style={{ minHeight: "320px" }}>
          ...
          >
            <svg viewBox="0 0 1200 1200" className="h-full w-full" fill="none">
              ...
              <path d="M 280 420 L 360 420" fill="none" stroke="var(--nyx-accent)" strokeWidth="2" strokeLinecap="round" filter="url(#cobaltGlow-privacy)" />
              <circle r="4" fill="var(--nyx-accent)" cx="320" cy="470" />
              <defs>
                <filter id="cobaltGlow-privacy">
                  <feGaussianBlur stdDeviation="4" result="blur" />
                  <feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge>
                </filter>
                <mask id="fadeMask-privacy">
                  <rect width="1200" height="1200" fill="white" />
                  <rect x="0" y="940" width="1200" height="260" fill="black" />
                  <rect x="0" y="0" width="180" height="1200" fill="black" />
                </mask>
              </defs>
              <rect width="1200" height="1200" fill="rgba(255,255,255,0.04)" opacity="0.18" mask="url(#fadeMask-privacy)" />
            </svg>
          </div>
        </div>
